...
namespace RE {
   ...
   static_assert(sizeof(TESFaction) == 0x98, "TESFaction is the wrong size.");
   static_assert(offsetof(TESFaction, vendorData) == 0x60, "TESFaction::vendorData is at the wrong offset.");
};