...
namespace RE {
   ...
   class MenuTopicManager {
		public:
			...
			BSTEventSink<PositionPlayerEvent> playerPositionEvent;	// 04
			UInt32     unk08[(0x1C - 0x08) >> 2];			// 08
			void* unk1C;
			...
			DEFINE_MEMBER_FN(Subroutine00898190, void, 0x00898190); // related to UI; creates BSUIMessageData and sends it to UIManager
			DEFINE_MEMBER_FN(Subroutine008982E0, void, 0x008982E0); // related to UI; creates BSUIMessageData and sends it to UIManager
